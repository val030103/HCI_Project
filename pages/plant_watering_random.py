...
st.write("Get a randomized watering schedule for your plants, ensuring a balanced routine.")
st.write("Each cycle assigns different times, adding variety to your watering habits.")
...
with col2:
    if st.button("Schedule"):
        st.switch_page("pages/plant_watering_random_schedule.py")

with col3:
    if st.button("Checkup"):
        st.switch_page("pages/plant_watering_random_checkup.py")
